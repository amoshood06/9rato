    ...
    <div class="w-full max-w-sm space-y-8">
        ...
        <div class="space-y-2">
            <div class="flex items-center gap-2">
                <div class="h-8 w-8 rounded-full bg-[#00372B] p-2">
        ...
        <form wire:submit="login" class="space-y-4">
            ...
            <div class="space-y-2">
                <div class="flex items-center justify-between">
                    ...
                    <a href="/forgot-password" class="text-sm text-[#00372B] hover:underline">
                        Forgot password?
                    </a>
                </div>
                <div class="relative">
            ...
            <button 
                ...
                class="w-full rounded-md bg-[#00372B] px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600/50"
            >
                Log in
            </button>
            <button 
        ...
        <div class="space-y-4">
            <div class="text-center text-sm">
                ...
                <a href="{{ route('auth.register') }}" class="font-semibold text-[#00372B] hover:underline">
                    Sign Up
                </a>
            </div>
