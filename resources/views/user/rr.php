...
<body class="bg-[#005B49]">
    ...
    <header class="flex justify-between items-center p-4">
        ...
        <img src="../asset/image/logos.png" alt="9rato Logo" class="h-12 hidden lg:block">
    ...
    <a href="" class="block p-3 hover:bg-orange-100 rounded-lg">Chat</a>
    <a href="#" class="block p-3 hover:bg-orange-100 rounded-lg">Sell</a>
    <a href="#" class="block p-3 hover:bg-orange-100 rounded-lg">Bid</a>
    <a href="#" class="block p-3 hover:bg-orange-100 rounded-lg">Swap</a>
    <a href="#" class="block p-3 hover:bg-orange-100 rounded-lg">Trade</a>
    <a href="#" class="block p-3 hover:bg-orange-100 rounded-lg">Rent</a>
    <a href="" class="block p-3 hover:bg-orange-100 rounded-lg">Withdrawal</a>
    ...
    <a href="#" class="block p-3 hover:bg-orange-100 rounded-lg">Setting</a>
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-[#ff6b00] p-4 rounded-lg text-white text-center">
                        <div class="mb-2">🚚</div>
                        <div class="text-sm">Upload Items</div>
                    </div>
                    <div class="bg-[#ff6b00] p-4 rounded-lg text-white text-center">
                        <div class="mb-2">🚚</div>
                        <div class="text-sm">Trade</div>
                    </div>
                    <div class="bg-[#ff6b00] p-4 rounded-lg text-white text-center">
                        <div class="mb-2">🛒</div>
                        <div class="text-sm">Bid</div>
                    </div>
                    <div class="bg-[#ff6b00] p-4 rounded-lg text-white text-center">
                        <div class="text-2xl font-bold">5</div>
