...
<body class="bg-brand-green">
    ...
    <header class="flex justify-between items-center p-4">
        ...
        <div class="flex items-center hidden lg:flex">
            <h1 class="text-2xl md:text-3xl font-bold text-white">9RATO</h1>
        </div>
        ...
        <div class="flex gap-6 relative">
            ...
            <div id="sidebar" class="fixed inset-y-0 left-0 lg:relative lg:block bg-white z-50 w-64 h-screen overflow-y-auto transition-transform duration-300 ease-in-out transform -translate-x-full lg:translate-x-0">
                <div class="flex flex-col h-full">
                    ...
                    <div class="lg:hidden flex justify-between items-center p-4 border-b">
                        <h1 class="text-xl font-bold text-brand-orange">9RATO</h1>
                    ...
                    <div class="flex-grow overflow-y-auto">
                        ...
                        <nav class="space-y-2 px-4">
                            <a href="" class="block p-3 bg-brand-orange text-white rounded-lg">Home</a>
                        ...
                        <div class="lg:hidden mt-8 px-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <a href="#" class="bg-brand-orange p-4 rounded-lg text-white text-center">
            ...
            <div class="flex-1">
                ...
                <div class="mb-6 rounded-lg overflow-hidden shadow-md">
                    <div class="relative bg-gradient-to-r from-brand-green to-green-700 p-4 text-white ad-animation">
                        ...
                        <div class="flex items-center">
                            <div class="flex-1">
                                ...
                                <button class="bg-white text-brand-green px-4 py-1 rounded-full text-sm font-bold">Learn More</button>
                            </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
                    <div class="bg-brand-orange p-4 rounded-lg text-white text-center">
                    ...
                    <div class="bg-gray-100 rounded-lg p-4 shadow-md">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <h4 class="font-bold text-brand-green">Premium Product</h4>
                    ...
                    <div class="bg-gray-100 rounded-lg p-4 shadow-md">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <h4 class="font-bold text-brand-green">Partner Services</h4>
                ...
                <div class="hidden sm:block bg-gray-200 rounded-lg overflow-x-auto custom-scrollbar">
                    <table class="w-full">
                        <thead class="bg-brand-orange text-white">
                            <tr>
                ...
                <div class="block sm:hidden">
                    <div class="bg-brand-orange rounded-lg p-3 text-white font-bold text-center mb-3">
                        Transaction History
                    </div>
                    <div class="space-y-3">
                        ...
                        <div class="bg-gray-100 rounded-lg p-3 shadow-sm">
                            <div class="flex justify-between mb-1">
                                ...
                                <span class="font-bold text-brand-orange">N5000</span>
                            </div>
                    ...
                    <div class="bg-gray-100 p-4">
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <div class="text-center sm:text-left sm:flex-1">
                                ...
                                <h3 class="text-lg font-bold text-brand-green mb-1">Download Our Mobile App</h3>
                                ...
                                <div class="flex justify-center sm:justify-start space-x-2">
                                    <button class="bg-brand-green text-white px-4 py-1 rounded-full text-sm">App Store</button>
                                    <button class="bg-brand-green text-white px-4 py-1 rounded-full text-sm">Google Play</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-center mt-4 space-x-4">
                    <button class="bg-brand-orange text-white px-4 py-2 rounded-full">
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-10 pb-0">
        <div class="grid grid-cols-5 gap-1">
            <a href="#" class="flex flex-col items-center justify-center p-2 text-brand-orange">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
